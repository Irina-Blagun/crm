...
/// Start При загрузке страницы
        ...
        var data = Accounting.find({product_id: localStorage.getItem('product'), type: 'Приход', created: {$lt: toDate, $gte: fromDateMonth}}).fetch();
        ...
        var data2 = Accounting.find({product_id: localStorage.getItem('product'), type: 'Продажа', created: {$lt: toDate, $gte: fromDateMonth}}).fetch();
        ...
        drawChartBar(results, results2, monthe);
...
/// Start Диаграмма при изменении конечной даты
        ...
        $(function () {
            ...
            $("#datetimepicker2").on("dp.change", function (e) {
                ...
                Accounting.find({product_id: localStorage.getItem('product'), type: 'Приход', created: {$lt: toDate, $gte: fromDateMonth}}).fetch();
                var results = [];
                var summ = 0;
                var monthes = [];
                var monthe = [];
